  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group position={[0.61, 0.89, -1.71]} rotation={[-3.14, -0.07, 3.14]} scale={[0.3, 0.3, 0.3]}>
        <mesh receiveShadow castShadow material={materials['Material.035']} geometry={nodes.Cone012.geometry} />
        <mesh receiveShadow castShadow material={materials['Material.036']} geometry={nodes.Cone012_1.geometry} />
      </group>
      ...
      <group name="Cube003" position={[3.32, 0.24, 2.69]} rotation={[0, 1.36, 0]} scale={[0.12, 0.12, 0.12]}>
        <mesh receiveShadow castShadow material={materials['Material.055']} geometry={nodes.Cube018.geometry} />
        <mesh receiveShadow castShadow material={materials.ramen} geometry={nodes.Cube018_1.geometry} />
      </group>
      <mesh receiveShadow castShadow
